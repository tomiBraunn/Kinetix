...
async function create(req, res) {
  try {
    const { nombre, apellido, fecha_nacimiento, tipo_lesion, observaciones } = req.body;
    if (!nombre || !apellido) {
...
async function update(req, res) {
  try {
    ...
    const { nombre, apellido, fecha_nacimiento, tipo_lesion, observaciones, activo } = req.body;
