...
export default function Landing() {
  ...
  return (
    <div className="landing">
        ...
        <div className="navbar-inner">
          <div className="logo">
            <div className="logo-k-wrap">
              <img src={logoMark} alt="" className="logo-k-img" />
            </div>
          ...
          <ul className="nav-links">
            ...
            <li><a href="#kinesiologos">Para kinesiólogos</a></li>
            <li><a href="#ia">IA integrada</a></li>
          </ul>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            <button className="btn-primary" onClick={() => navigate("/register")}>Empezar</button>
      ...
      <section id="incluye" className="features">
        ...
        <div className="features-grid">
          ...
          <div className="feature-card">
            ...
            <div className="feature-widget games-widget">
              <span className="games-number">3</span>
      ...
      <section id="kinesiologos" className="cta-kine">
        ...
        <div className="cta-card">
          ...
          <div className="cta-buttons">
            ...
            <button className="btn-outline" onClick={() => navigate("/register")}>Registrarse</button>
          </div>
        </div>
      </section>
        ...
        <div className="footer-inner">
          <div className="footer-left">
            ...
            <p className="footer-copy">
              © 2026 Kinetix.
              <br />
              Rehabilitación gamificada con IA
              <br />
              para consultorios de kinesiología.
            </p>
          </div>
